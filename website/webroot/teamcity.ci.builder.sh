...
#####
PROJECT_NAME='SEAD-fund' #This name will be used to create/or/refer-to the directory of the project in /home/winterwell/
GIT_REPO_URL='github.com:/winterstein/SEAD-fund' #
...
TARGET_SERVERS=(bailey.good-loop.com)
